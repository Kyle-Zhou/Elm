...
public class WestEntrance : Entrance
{
    private void Start()
    {
    ...
    {
        RoomTransitionAnims.instance.MovingLeftAnimStart();
        yield return new WaitForSeconds(0.25f);
        RoomManager.instance.MoveRoomLeft();
        RoomTransitionAnims.instance.MovingLeftAnimEnd();
    }
}
