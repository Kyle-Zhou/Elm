...
public class SouthEntrance : Entrance
{
    private void Start()
    {
    ...
    {
        RoomTransitionAnims.instance.MovingDownAnimStart();
        yield return new WaitForSeconds(0.25f);
        RoomManager.instance.MoveRoomDown();
        RoomTransitionAnims.instance.MovingDownAnimEnd();
    }
}
